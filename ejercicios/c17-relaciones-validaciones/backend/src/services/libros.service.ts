...
const create = async (payload: Prisma.LibroUncheckedCreateInput): Promise<Libro> => {
  return prisma.libro.create({ data: payload });
};

const update = async (id: number, payload: Prisma.LibroUncheckedUpdateInput): Promise<Libro | null> => {
